...
K=20
N=8
outpath=output/oldb_devss1.0/oldb${prob_num}/beta${beta_name}/tempconv/ 
...
###############################################################################################################################################################
t=0.0001
outpath=output/oldb_devss1.0/oldb${prob_num}/beta${beta_name}/spatconv/
...
do
outpath=output/oldb_devss1.0/oldb${prob_num}/beta${beta_name}/we${we}/
for K in 26 31
do
