...
K=20
N=8
outpath=output/oldb_devss0.5/oldb${prob_num}/tempconv/ 
...
###############################################################################################################################################################
t=0.0001
outpath=output/oldb_devss0.5/oldb${prob_num}/spatconv/
...
do
outpath=output/oldb_devss0.5/oldb${prob_num}/we${we}/
for K in 26 31
do
