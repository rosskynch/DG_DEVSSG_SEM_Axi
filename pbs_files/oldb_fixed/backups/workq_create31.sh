...
echo '#PBS' -q workq >> oldb${prob_num}_tempconv_we${we}_K${K}_N${N}.pbs
...
echo '#PBS' -l select=1:ncpus=16:mpiprocs=16 >> oldb${prob_num}_tempconv_we${we}_K${K}_N${N}.pbs
echo '#PBS' -l place=scatter:excl >> oldb${prob_num}_tempconv_we${we}_K${K}_N${N}.pbs
echo '#PBS' -l walltime=72:00:00 >> oldb${prob_num}_tempconv_we${we}_K${K}_N${N}.pbs
...
echo '#PBS' -q workq >> oldb${prob_num}_spatconv_we${we}_dt${t}_K${K}.pbs
...
echo '#PBS' -l select=1:ncpus=16:mpiprocs=16 >> oldb${prob_num}_spatconv_we${we}_dt${t}_K${K}.pbs
echo '#PBS' -l place=scatter:excl >> oldb${prob_num}_spatconv_we${we}_dt${t}_K${K}.pbs
echo '#PBS' -l walltime=72:00:00 >> oldb${prob_num}_spatconv_we${we}_dt${t}_K${K}.pbs
...
echo '#PBS' -q workq >> oldb${prob_num}_we${we}_dt${t}_K${K}_N${N}.pbs
...
echo '#PBS' -l select=1:ncpus=16:mpiprocs=16 >> oldb${prob_num}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -l place=scatter:excl >> oldb${prob_num}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -l walltime=72:00:00 >> oldb${prob_num}_we${we}_dt${t}_K${K}_N${N}.pbs
