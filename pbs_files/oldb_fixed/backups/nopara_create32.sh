...
echo '#PBS' -q SMP_queue >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
...
echo '#PBS' -l select=1:ncpus=16:mpiprocs=1 >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -l place=scatter:excl >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -l walltime=48:00:00 >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
