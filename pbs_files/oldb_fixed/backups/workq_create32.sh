...
echo '#PBS' -q workq >> oldb${prob_num}_tempconv_beta${beta_name}_we${we}_K${K}_N${N}.pbs
...
echo '#PBS' -l select=1:ncpus=16:mpiprocs=16 >> oldb${prob_num}_tempconv_beta${beta_name}_we${we}_K${K}_N${N}.pbs
echo '#PBS' -l place=scatter:excl >> oldb${prob_num}_tempconv_beta${beta_name}_we${we}_K${K}_N${N}.pbs
echo '#PBS' -l walltime=72:00:00 >> oldb${prob_num}_tempconv_beta${beta_name}_we${we}_K${K}_N${N}.pbs
...
echo '#PBS' -q workq >> oldb${prob_num}_spatconv_beta${beta_name}_we${we}_dt${t}_K${K}.pbs
...
echo '#PBS' -l select=1:ncpus=16:mpiprocs=16 >> oldb${prob_num}_spatconv_beta${beta_name}_we${we}_dt${t}_K${K}.pbs
echo '#PBS' -l place=scatter:excl >> oldb${prob_num}_spatconv_beta${beta_name}_we${we}_dt${t}_K${K}.pbs
echo '#PBS' -l walltime=72:00:00 >> oldb${prob_num}_spatconv_beta${beta_name}_we${we}_dt${t}_K${K}.pbs
...
do
echo '#!/bin/bash' > oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -q workq >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -N oldb${prob_num} >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -o oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}-out.txt >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -e oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}-err.txt >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -l select=1:ncpus=16:mpiprocs=16 >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -l place=scatter:excl >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PBS' -l walltime=72:00:00 >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo '#PROJECT=PR58' >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo 'module load compiler/intel-13' >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo 'cd $PBS_O_WORKDIR' >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
echo >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs

cat ../../scripts/oldb_fixed/oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.sh >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N}.pbs
