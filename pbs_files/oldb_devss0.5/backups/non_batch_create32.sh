...
cat ../../scripts/oldb_devss0.5/oldb${prob_num}_tempconv_beta${beta_name}_we${we}_K${K}_N${N}.sh >> oldb${prob_num}_tempconv_beta${beta_name}_we${we}_K${K}_N${N}.pbs
...
cat ../../scripts/oldb_devss0.5/oldb${prob_num}_spatconv_beta${beta_name}_we${we}_dt${t}_K${K}.sh >> oldb${prob_num}_spatconv_beta${beta_name}_we${we}_dt${t}_K${K}.pbs
done
...
cat ../../scripts/oldb_devss0.5/oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}.sh >> oldb${prob_num}_beta${beta_name}_we${we}_dt${t}_K${K}.pbs
