...
####################################
COUNTER=0
infile=${inpath}/fixedcylindermeshK${K}.dat
outpath=output/${output_dir}/${model}${prob_num}/tempconv
...
echo outfile${COUNTER}='${CODEPATH}'/${outpath}/${job_name}_we${we}_dt${t}_K${K}_N${N} >> ${pbs_file}
