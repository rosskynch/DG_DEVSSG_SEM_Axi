...
CODEPATH=$HOME/FINAL/
job_name=${model}${prob_num}_spatconv
job_folder=${model}${prob_num}'_devss1.0_spatconv'
pbs_file=${model}${prob_num}_spatconv.pbs
...
outpath=output/${output_dir}/${model}${prob_num}/alpha${alpha_gies}/beta${beta_name}/spatconv
...
echo outfile${COUNTER}='${CODEPATH}'/${outpath}/${job_name}_beta${beta_name}_we${we}_dt${t}_K${K}_N${N} >> ${pbs_file}
