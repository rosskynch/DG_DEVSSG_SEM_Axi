...
CODEPATH=$HOME/FINAL/
job_name=${model}${prob_num}_tempconv
job_folder=${model}${prob_num}'_devss1.0_tempconv'
pbs_file=${model}${prob_num}_tempconv.pbs
...
outpath=output/${output_dir}/${model}${prob_num}/alpha${alpha_gies}/beta${beta_name}/tempconv
